!(function (e) {
                    ...
                    return (function (t) {
                       ...
                       function s(e) {
                          ...
                          if (
                             ...
                             o && o(),
                             r !== i &&
                                (t.dispatchEvent(new Event('autosize:resized', { bubbles: !0 })),
                                (r = i)),
                             c !== n.overflow && !a)
                          ) {
                             var f = n.textAlign;
                             ('hidden' === n.overflow &&
                                (t.style.textAlign = 'start' === f ? 'end' : 'start'),
                                s({ restoreTextAlign: f, testForHeightReduction: !0 }));
                          }
                       }
                       function a() {
   ...
   document.addEventListener('alpine:init', () => {
      var e;
      ((e = window.Alpine).directive('autosize', (e, { modifiers: t }, { cleanup: o }) => {
         n(e);
         const r = Array.from(e.attributes);
         let i = !1;
         for (let { nodeName: e } of r)
            if ('wire:model' === e || e.startsWith('wire:model.')) {
               i = !0;
               break;
            }
         !e.hasAttribute('wire:ignore') && i && e.setAttribute('wire:ignore', '');
         const l = () => {
            n.update(e);
         };
         (e.addEventListener('autosize', l),
            o(() => {
               (n.destroy(e), e.removeEventListener('autosize', l));
            }));
      }),
         e.magic('autosize', (e) => (t) => {
            (t || e).dispatchEvent(new Event('autosize'));
         }));
   });
});
